...
class SchoolDAO:
    ...
    def create(self, university):
        sql = "INSERT INTO university (ID, name, address, number_of_pupils) VALUES (%s, %s, %s, %s)"
        values = (university.get("ID"), university.get("name"), university.get("address"), university.get("number_of_pupils"))
